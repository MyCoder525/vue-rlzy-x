<template>
  <div class="dashboard-container">
      ...
      <div>
        <div class="fl headL">
          <div class="headImg">
            ...
            <el-avatar style="width:100%; height:100%;" :src="avatar"></el-avatar>
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">{{ companyName }}，祝你暴瘦暴富！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
    ...
    <el-row type="flex" justify="space-between">
      ...
      <el-col :span="13" style="padding-right:26px">
        ...
        <el-card class="box-card">
          ...
          <!-- 放置日历组件 -->
          <workcalendar :currentDate="new Date()"></workcalendar>
        </el-card>
        <!-- 公告 -->
        <el-card class="box-card">
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            ...
            <el-button class="sideBtn" @click="$router.push('/info')">我的信息</el-button>
          </div>
        </el-card>
    ...
    <el-dialog :visible="showDialog" title="离职申请" @close="btnCancel">
      <el-form ref="ruleForm" :model="ruleForm" label-width="110px" :rules="rules">
        <!--离职表单-->
        ...
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" type="textarea" :autosize="{ minRows: 1, maxRows: 2 }" style="width: 70%;"
            placeholder="请输入内容" />
        </el-form-item>
      </el-form>
  ...
  methods: {
    btnOK() {
      this.$refs.ruleForm.validate(async validate => {
        if (validate) {
          const data = { ...this.ruleForm, userId: this.$store.getters.userId }
